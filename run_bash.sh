...
\${cwd}/standalone/cat_standalone.sh  -s \$cwd -m \$cwd/v93 -b \${cwd}/standalone/cat_standalone_segment.m   -a1 \" '${cat12_dir}/templates_MNI152NLin2009cAsym/TPM_Age11.5.nii' \"   -a2 \" '${cat12_dir}/templates_MNI152NLin2009cAsym/Template_0_GS.nii' \"  ${i}    " >sh$t.sh;
done

ls sh* |parallel -j 60 bash -x 
